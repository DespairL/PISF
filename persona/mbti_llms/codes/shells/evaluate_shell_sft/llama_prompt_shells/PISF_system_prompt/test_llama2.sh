...
output_path="sft_llama_no_sys_p_2.json"
for mbti_type in ISTJ ISTP ISFP ISFJ #ESTP ESTJ ESFP ESFJ ENFJ ENFP ENTP ENTJ ISTJ ISTP ISFP ISFJ INFJ INFP INTP INTJ I T F J # S N P #
do
