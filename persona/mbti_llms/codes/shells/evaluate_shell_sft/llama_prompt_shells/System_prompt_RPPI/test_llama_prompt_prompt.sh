...
GPU=6
write_path_c="/data/NJU/datasets/persona/mbti_llms/results/debias_results/sft_llama2_chat_prompt_prompt.txt"
...
output_path="sft_llama_prompt_prompt.json"
for mbti_type in ESTP ESTJ ESFP ESFJ ENFJ ENFP ENTP ENTJ ISTJ ISTP ISFP ISFJ INFJ INFP INTP INTJ #I T F J # S N P #
do
