...
output_path="sft_llama_sft_prompt_prompt.json"
for mbti_type in I S N T #ESTP ESTJ ESFP ESFJ ENFJ ENFP ENTP ENTJ ISTJ ISTP ISFP ISFJ INFJ INFP INTP INTJ I T F J # S N P #
do
