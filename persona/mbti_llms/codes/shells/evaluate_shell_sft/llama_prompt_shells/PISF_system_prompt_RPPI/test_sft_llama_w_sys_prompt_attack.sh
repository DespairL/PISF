set -e
# NOTE: System Prompt + SFT -> User Prompt 反向诱导
...
GPU=4
write_path_c="/data/NJU/datasets/persona/mbti_llms/results/debias_results/sft_llama2_chat_sft_prompt_prompt.txt"
...
output_path="sft_llama_sft_prompt_prompt_4.json"
for mbti_type in ESTP ESTJ ESFP ESFJ ENFJ ENFP ENTP ENTJ ISTJ ISTP ISFP ISFJ INFJ INFP INTP INTJ #I T F J # S N P E
do
