set -e
GPU=5
write_path_c="/data/NJU/datasets/persona/mbti_llms/results/debias_results/sft_llama2_chat_with_instruction_re.txt"
...
output_path="sft_llama_with_instruction_re.json"
