...
GPU=6
model_size='7b'
write_path_c="/data/NJU/datasets/persona/mbti_llms/results/debias_results/qwen${model_size}_with_user_prompt.txt"
...
output_path="qwen${model_size}_with_user_prompt.json"
count=0
for mbti_type in no #E I S N T F J P ESTP ESTJ ESFP ESFJ ENFJ ENFP ENTP ENTJ ISTJ ISTP ISFP ISFJ INFJ INFP INTP INTJ #
do
