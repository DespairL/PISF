...
GPU=6 # 1,3
write_path_c="/data/NJU/datasets/persona/mbti_llms/results/debias_results/sft_qwen_with_sys_prompt.txt"
...
output_path="sft_qwen_with_sys_prompt_2.json"
count=0
for mbti_type in E #I S N T F J P ESTP ESTJ ESFP ESFJ ENFJ ENFP ENTP ENTJ ISTJ ISTP ISFP ISFJ INFJ INFP INTP INTJ # E
do
