for mbti_type in ENTJ ENFP ENFJ ENTP ESTJ ESTP ESFP ESFJ INTJ INTP INFP INFJ ISTJ ISTP ISFP ISFJ E I S N T F J P
do
    LR=5e-6
    ...
    deepspeed --include localhost:1,2,3,4,5,6 --master_port $MASTER_PORT ${base_dir}pretrain.py \
        ...
        --model_name_or_path /data/NJU/datasets/persona/models/Qwen-7B-Chat \
        --output_dir  /data/NJU/datasets/persona/models/continual_pretrain/Qwen-7B-Chat-$SAVE_SUFFIX \
