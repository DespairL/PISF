...
class DeepSpeedRLHFEngine():
    ...
    def _init_actor(self, actor_model_name_or_path):
        ...
        if self.args.resume_training:
            assert self.args.resume_training_save_path
            save_path = os.path.join(self.args.resume_training_save_path, self.args.mbti)
            print(f'Resume checkpoint from {save_path}, tag:actor')
            actor_engine.load_checkpoint(save_path, tag='actor')
    ...
    def _init_critic(self, critic_model_name_or_path):
        ...
        if self.args.resume_training:
            assert self.args.resume_training_save_path
            save_path = os.path.join(self.args.resume_training_save_path, self.args.mbti)
            print(f'Resume checkpoint from {save_path}, tag:critic')
            critic_engine.load_checkpoint(save_path, tag='critic')
